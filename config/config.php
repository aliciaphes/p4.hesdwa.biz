...
*/ 	
	define('SYSTEM_EMAIL', 'apr.crg@gmail.com'); 

# Default DB name for this app
	define('DB_NAME', 'hesdwabi_p4_hesdwa_biz'); 
...
# For extra security, you might want to set different salts than what the core uses
	define('PASSWORD_SALT', 'DHHi0TifQpShfHbiEU-BNIN8i@F4LVQRjW(7UiwB');
	define('TOKEN_SALT', 	'5FY_9odGhb%y&&%@L#E(omI-Ex92@8gJMqPjBxhv');